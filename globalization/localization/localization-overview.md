...
Whether your deliverables include software, multimedia, PDF documents, or websites, they need to be localized for the target audience. Localization increases customer satisfaction and gives your product access to new markets, meaning new sources of revenue.
...
The above example is greatly simplified. Localization affects your entire deliverable, not just its textual content. When localization is done correctly, the following things and more are considered:
