...
If a colon is followed immediately by more text, the first word after the colon does not get a capital letter, if the item following the colon is a single sentence.
