...
- [Unicode enabled](https://docs.microsoft.com/en-us/globalization/input/ensure-that-the-application-is-fully-unicode-enabled)
- [Keyboards, Other Input Methods, and Text Predication](https://docs.microsoft.com/en-us/globalization/input/keyboards)
