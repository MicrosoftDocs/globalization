...
**Note:** Font linking requires specifying the priority of the fonts in linked together as though in a chain. A font later in the chain can only add glyphs to an earlier font; you cannot override or replace glyphs in the early font.
...
|:---:|:---:|:---:|
| ![Sans Serif](https://docs.microsoft.com/globalization/input/images/SansSerif.jpg "Sans Serif")                    |  ![Traditional Arabic](https://docs.microsoft.com/globalization/input/images/TradArabic.jpg "Traditional Arabic")                 |   ![Leelawadee](https://docs.microsoft.com/globalization/input/images/Leelawadee.jpg "Leelawadee")         |
...
-   [Script and Font Support in Windows](https://docs.microsoft.com/globalization/input/font-support)
