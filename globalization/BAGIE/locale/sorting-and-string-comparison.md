...
Overview of sorting
- Turkish i
- Spanish (modern vs traditional)

Collation rules - definition
Sorting based on collation rules
Normalization https://en.wikipedia.org/wiki/Unicode_equivalence
Culture-insensitive operations: https://docs.microsoft.com/en-us/dotnet/standard/globalization-localization/culture-insensitive-string-operations


Handling difficult languages
Japanese - JIS X 4061
Chinese - radical/stroke
Thai/Lao
See ##Market Specific Sorting Examples below

Some good information here https://unicode-org.github.io/icu/userguide/collation/concepts.html

Might be nice to add a summary of language specific conventions like: https://en.wikipedia.org/wiki/Alphabetical_order#Language-specific_conventions

CLDR: https://unicode.org/reports/tr35/tr35-collation.html#Contents

Implementations
ICU
.NET
SQL: https://docs.microsoft.com/en-us/sql/relational-databases/collations/collation-and-unicode-support
