...
-   Strings are not built at run time by stripping or concatenation. String substitution is done via language-aware APIs such as [FormatMessage](/windows/desktop/api/winbase/nf-winbase-formatmessage.md).
