...
[Avoid Run-Time Composite Strings](avoid-run-time-composite-strings)

[When Variables Are Necessary, Use Unique Names](when-variables-are-necessary)

[Win32—FormatMessage](win32-formatmessage)

[.NET Framework—String.Format](dotnet-framework-string-format)

[Do Not Compound Several Variables](do-not-compound-several-variables)

[Keep Sentences in a Single String](keep-sentences-in-a-single-string)

[Watch Your String Buffer Sizes](watch-your-string-buffer-sizes)
